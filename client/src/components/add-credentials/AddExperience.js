    ...
    return (
      <div className = "add-experience">
        ...
        <div className = "col-md-8 m-auto">
            ...
            <p className = "lead text-center"> Add any job or position that you've hadin the past or current</p>
...
export default connect(mapStateToProps, {addExperience})(withRouter(AddExperience)); //withRouter is used for redirect